...
#include <memory>
#include "../../systemplus/addstudentwidget.h"
...
QT_MOC_LITERAL(4, 44, 23) // "on_cancelButton_clicked"
    ...
    "AddStudentWidget\0back\0\0on_addButton_clicked\0"
...
void AddStudentWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (AddStudentWidget::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddStudentWidget::back)) {
                *result = 0;
                return;
            }
        }
